...
function Import(contractingproessid, database, numberStage, registerid) {
    ...
    this.importParties = async function(parties) {
        let schema = {
            ...
            address: {
                address_typeofroad: 'address_typeofroad',
                address_streetaddress: 'address_streetaddress',
                address_outdoornumber: 'address_outdoornumber',
                address_interiornumber: 'address_interiornumber',
                address_typeofsettlement: 'address_typeofsettlement',
                address_settlementname: 'address_settlementname',
                address_alcaldiakey: 'address_alcaldiakey',
                address_locality: 'address_locality',
                address_region: 'address_region',
                address_regionkey: 'address_regionkey',
                address_locationname: 'address_locationname',
                address_localitykey: 'address_localitykey',
                address_postalcode: 'address_postalcode',
                address_countryname: 'address_countryname',
                address_streetabroad: 'address_streetabroad',
                address_numberabroad: 'address_numberabroad',
                address_cityabroad: 'address_cityabroad',
                address_countryabroad: 'address_countryabroad',
            },
            contactPoint: {
