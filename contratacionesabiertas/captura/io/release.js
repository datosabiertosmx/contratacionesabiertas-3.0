...
function release(db) {
    ...
    let generateParties = async function () {
        ...
        return parties.map(p => clean({
            ...
            address: clean({
                address_typeofroad: p.address_typeofroad,
                address_streetaddress: p.address_streetaddress,
                address_outdoornumber: p.address_outdoornumber,
                address_interiornumber: p.address_interiornumber,
                address_typeofsettlement: p.address_typeofsettlement,
                address_settlementname: p.address_settlementname,
                address_alcaldiakey: p.address_alcaldiakey,
                address_locality: p.address_locality,
                address_region: p.address_region,
                address_regionkey: p.address_regionkey,
                address_locationname: p.address_locationname,
                address_localitykey: p.address_localitykey,
                address_postalcode: p.address_postalcode,
                address_countryname: p.address_countryname,
                address_streetabroad: p.address_streetabroad,
                address_numberabroad: p.address_numberabroad,
                address_cityabroad: p.address_cityabroad,
                address_countryabroad: p.address_countryabroad,
            }),
            contactPoint: clean({
